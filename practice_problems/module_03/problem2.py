...
# concatenation
statement = "Hello, " + name + "! you are " + str(age) \
+ " years old. Next year, you will be " + str(next_year) + " years old."
print(statement)

# f-string allow variables to be embedded into expressions
print(f"Hello, {name}! You are {age} years old. Next year, \
you will be {next_year} years old.")
